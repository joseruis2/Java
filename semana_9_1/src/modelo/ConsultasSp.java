...
public class ConsultasSp {
    ...
    public boolean registrar(ventas a){
        ...
        try {
            ...
            String consulta = "{call registrar_ventas(?,?,?,?)}";
    ...
    public List<ventas> listar() throws SQLException{
        ...
        String sql = "{call listar_ventas()}"; //Consulta SQL para seleccionar todos los registros de la tabla alumno
    ...
    public boolean eliminar(String cod){
        ...
        try {
            ...
            String consulta = "{call eliminar_ventas(?)}";
            pst = cn.prepareCall(consulta); // Preparar la consulta SQL
    ...
    public boolean actualizar(ventas a){
        ...
        try {//Consulta SQL para actualizar los datos de un registro de alumno
            String consulta = "{call actualizar_ventas(?,?,?)}";
